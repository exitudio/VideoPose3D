...
# args.viz_subject = ','.join(list(keypoints.keys()))
...
if args.render:
    print('Rendering...')
    for subj in list(keypoints.keys()):
        args.viz_subject = subj
        ...
        if args.viz_export is not None:
            ...
            trim_id = int(prediction.shape[0]/4)
            prediction = prediction[trim_id+1: prediction.shape[0]-trim_id]
            # Predictions are in camera space
            np.save(args.viz_export+args.viz_subject.replace('.avi', ''), prediction)
